...
class ApiClient {
     ...
     */
    async getMoviles() {
        return this.get('/moviles/');
    }

    async getMovil(id) {
        return this.get(`/moviles/${id}/`);
    }

    async createMovil(data) {
        return this.post('/moviles/', data);
    }

    async updateMovil(id, data) {
        return this.put(`/moviles/${id}/`, data);
    }

    async patchMovil(id, data) {
        return this.patch(`/moviles/${id}/`, data);
    }

    async deleteMovil(id) {
        return this.delete(`/moviles/${id}/`);
    }
